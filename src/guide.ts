...
function standardGuide(): string {
  return [
    ...
    "- Today's strain is still accumulating and the first day of wear is partial; both are left out of averages and flagged.",
...
function aggregateGuide(): string {
  return [
    ...
    "- standard (the default elsewhere): day-level tools, records, resources and prompts. Aggregate mode reduces disclosure; it is not anonymization.",
    "",
    "## Rate limits and history loading",
    "",
