...
function errorResponse(error: unknown): {
  ...
  if (whoopMessage !== undefined) {
    ...
    // A RangeError from processing WHOOP data says nothing actionable about the
    // request; its message may carry data values, so none of it is returned.
    message = "The server could not process the WHOOP data for this request.";
  } else {
